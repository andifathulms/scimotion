...
export function RadioactiveHalfLifeAnimation() {
  ...
  return (
    <div className="animation-block" ref={ref}>
      <canvas role="img" aria-label="Animated diagram: Radioactive half life. Values are reported below the diagram." ref={canvasRef} width={W} height={H} className="w-full rounded-lg" style={{ background: 'var(--color-canvas)' }} />
