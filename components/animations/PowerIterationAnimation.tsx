...
export function PowerIterationAnimation() {
  ...
  const [startAngle, setStartAngle] = useState(2.3)
    ...
    <div className="animation-block" ref={ref}>
      ...
      <div className="animation-controls">
        ...
        <div className="flex items-center gap-2 text-xs text-text-muted">
          <span>v₀ angle:</span>
          <input type="range" min={0} max={6.28} step={0.02} value={startAngle}
            onChange={e => { setRunning(false); setStep(0); setStartAngle(+e.target.value) }}
