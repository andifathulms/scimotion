...
export function WalkerCirculationAnimation() {
  ...
  return (
    <div ref={ref} className="animation-block">
      <canvas role="img" aria-label="Animated diagram: Walker circulation. Values are reported below the diagram." ref={canvasRef} width={W} height={H} className="w-full rounded-lg" style={{ background: 'var(--color-canvas)', aspectRatio: `${W} / ${H}` }} />
