  ...
  return (
    <div className="animation-block" ref={ref}>
      ...
      <div className="animation-canvas">
        <canvas role="img" aria-label="Animated diagram: Central Limit Theorem. Values are reported below the diagram." ref={canvasRef} width={W} height={H} className="w-full rounded-lg" style={{ background: 'var(--color-canvas)' }} />
      </div>
