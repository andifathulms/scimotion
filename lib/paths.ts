...
export const learningPaths: LearningPath[] = [
  {
    ...
    articleSlugs: ['eulers-formula', 'taylor-series', 'newtons-method', 'gradient-descent', 'eigenvectors-and-eigenvalues', 'fourier-transform'],
  },
  {
    ...
    articleSlugs: ['binary-search', 'sorting-algorithms', 'hash-tables', 'dynamic-programming', 'graph-traversal', 'sieve-of-eratosthenes', 'public-key-cryptography', 'neural-networks', 'p-vs-np'],
  },
  {
    ...
    articleSlugs: ['pendulum-motion', 'keplers-laws', 'doppler-effect', 'entropy-and-the-second-law', 'time-dilation', 'wave-particle-duality', 'superconductivity'],
  },
  {
    ...
    articleSlugs: ['action-potential', 'cardiac-electrical-signal', 'brownian-motion', 'chaos-theory', 'markov-chains', 'central-limit-theorem', 'bayes-theorem', 'information-theory', 'immune-response', 'glucose-insulin-regulation', 'dna-replication', 'pharmacokinetics'],
  },
]
