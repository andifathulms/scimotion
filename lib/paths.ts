...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['binary-search', 'sorting-algorithms', 'hash-tables', 'dynamic-programming', 'graph-traversal', 'sieve-of-eratosthenes', 'public-key-cryptography', 'neural-networks', 'distributed-consensus', 'p-vs-np', 'halting-problem'],
  },
  {
  ...
  },
  {
    ...
    articleSlugs: ['plate-tectonics', 'atmospheric-convection', 'ocean-circulation', 'greenhouse-effect', 'carbon-cycle', 'ice-ages'],
  },
]
