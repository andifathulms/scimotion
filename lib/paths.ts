...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['action-potential', 'cardiac-electrical-signal', 'brownian-motion', 'chaos-theory', 'markov-chains', 'central-limit-theorem', 'bayes-theorem', 'information-theory', 'immune-response', 'pharmacokinetics'],
  },
]
