...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['natural-selection', 'dna-replication', 'gene-expression', 'heredity', 'cell-division', 'protein-folding', 'enzymes', 'photosynthesis', 'cellular-respiration', 'cell-membranes', 'osmosis', 'action-potential', 'the-synapse', 'viruses', 'immune-response'],
  },
  {
