...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['binary-search', 'sorting-algorithms', 'hash-tables', 'dynamic-programming', 'graph-traversal', 'sieve-of-eratosthenes', 'public-key-cryptography', 'neural-networks', 'p-vs-np', 'halting-problem'],
  },
  {
    ...
    articleSlugs: ['pendulum-motion', 'resonance', 'keplers-laws', 'doppler-effect', 'entropy-and-the-second-law', 'time-dilation', 'electromagnetic-waves', 'wave-particle-duality', 'superconductivity'],
  },
  {
  ...
  },
  {
    ...
    articleSlugs: ['atomic-structure', 'chemical-bonding', 'reaction-kinetics', 'chemical-equilibrium', 'acids-and-bases', 'electrochemistry'],
  },
]
