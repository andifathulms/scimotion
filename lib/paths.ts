...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['action-potential', 'cardiac-electrical-signal', 'brownian-motion', 'markov-chains', 'central-limit-theorem', 'bayes-theorem', 'immune-response', 'pharmacokinetics'],
  },
]
