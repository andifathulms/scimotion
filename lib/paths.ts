...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['atomic-structure', 'radioactivity', 'periodic-table', 'the-mole', 'spectroscopy', 'chemical-bonding', 'intermolecular-forces', 'polymers', 'solutions', 'kinetic-theory', 'phase-transitions', 'reaction-kinetics', 'gibbs-free-energy', 'chemical-equilibrium', 'le-chatelier', 'acids-and-bases', 'redox', 'electrochemistry'],
  },
  {
    slug: 'planet-earth',
    title: 'Planet Earth',
  ...
  },
  {
    ...
    articleSlugs: ['the-heart', 'muscles', 'cardiac-electrical-signal', 'blood-pressure', 'gas-exchange', 'digestion', 'glucose-insulin-regulation', 'hormones', 'the-kidney', 'how-we-hear', 'vision', 'anesthesia', 'pharmacokinetics', 'antibiotic-resistance', 'cancer', 'mri-imaging', 'vaccines', 'epidemic-models'],
  },
  {
    ...
    articleSlugs: ['the-sun', 'life-cycle-of-stars', 'hr-diagram', 'stellar-nucleosynthesis', 'solar-system', 'the-moon', 'orbital-mechanics', 'comets', 'tidal-forces', 'exoplanets', 'black-holes', 'neutron-stars', 'gravitational-waves', 'galaxies-and-dark-matter', 'telescopes', 'cosmic-distance-ladder', 'cosmic-microwave-background', 'dark-energy', 'expanding-universe'],
  },
  {
