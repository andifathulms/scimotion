...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    articleSlugs: ['natural-selection', 'dna-replication', 'gene-expression', 'heredity', 'protein-folding', 'photosynthesis', 'cellular-respiration', 'action-potential', 'immune-response'],
  },
  {
